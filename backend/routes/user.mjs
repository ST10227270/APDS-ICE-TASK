...
router.post("/login", bruteforce.prevent, async (req, res) => {
    ...
    try{
        ...
        //Compare the provided password with the hashed password in thbe database
        ...
        if(!passwordMatch){
            ...
            const token = jwt.sign({username:req,body,username, password:req,body, password}, "this_secret_should_be _longer_then_it_is", {expiresIn: "1hr"})
